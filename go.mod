...
// Use the code below for local development of imported modules.
//replace (
//	github.com/theNewDynamic/tnd-assets-js/lazysizes => /Users/{replace_with_path}/tnd-assets-js/lazysizes
